...
switch(categoria){
    ...
    case "Vestidos":
        imagenProducto = "resource/img/vestido.jpeg";
        break;

    case "Blusas":
        imagenProducto = "resource/img/blusas.jpeg";
        break;

    case "Jeans":
        imagenProducto = "resource/img/jeans.jpeg";
        break;

    case "Faldas":
        imagenProducto = "resource/img/faldas.jpg";
        break;

    case "Bodys":
        imagenProducto = "resource/img/body.jpg";
        break;

    case "Conjuntos":
        imagenProducto = "resource/img/conjuntos.jpg";
        break;

    case "Chaquetas de mezclilla":
        imagenProducto = "resource/img/chaquetas.jpg";
        break;

    case "Blazers":
        imagenProducto = "resource/img/blazers.jpeg";
        break;

    case "Shorts":
        imagenProducto = "resource/img/shorts.jpeg";
        break;

    case "Enterizos":
        imagenProducto = "resource/img/enterizos.jpg";
        break;

    case "Conjuntos Deportivos":
        imagenProducto = "resource/img/conj_deportivos.png";
        break;

    case "Crop Tops":
        imagenProducto = "resource/img/crop_tops.png";
        break;

    default:
        imagenProducto = "resource/img/modaa.jpeg";
}
